...
void renderVanBox(pcl::visualization::PCLVisualizer::Ptr& viewer, int clusterId, float xmin, float ymin, float zmin, float xmax, float ymax, float zmax, bool display = false);
